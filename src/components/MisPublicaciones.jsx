...
const MisPublicaciones = () => {
      ...
      setPublications(
        publications.map((pub) =>
          pub._id === publicationId
            ? { ...pub, isPublished: response.data.isPublished }
            : pub
        )
      );
  ...
  const renderPublicationCard = (publication) => {
    ...
    switch (publication.type) {
      case "producto":
        specificFields = publication.stock && (
        ...
        break;
      case "servicio":
        specificFields = publication.duration && (
        ...
        break;
      case "renta":
        specificFields = publication.pricePerDay && (
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between">
          <div className="flex-1">
            <div className="flex items-start space-x-4">
              ...
              <div>
                {commonFields}
                {specificFields && <div className="mt-2">{specificFields}</div>}
              </div>
            </div>
          </div>
          <div className="mt-4 md:mt-0 flex items-center space-x-3">
            <div className="flex space-x-2">
              <button
                ...
                onClick={() =>
                  navigate(`/${viewRoutes[activeTab]}/${publication._id}`)
                }
              >
              ...
              <button
                ...
                onClick={() =>
                  navigate(`${editRoutes[activeTab]}/${publication._id}`)
                }
              >
